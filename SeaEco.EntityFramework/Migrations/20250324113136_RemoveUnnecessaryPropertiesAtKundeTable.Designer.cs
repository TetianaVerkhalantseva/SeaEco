...
namespace SeaEco.EntityFramework.Migrations
{
    ...
    [Migration("20250324113136_RemoveUnnecessaryPropertiesAtKundeTable")]
    partial class RemoveUnnecessaryPropertiesAtKundeTable
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("SeaEco.EntityFramework.Entities.BProsjekt", b =>
                {
                    ...
                    b.Property<Guid?>("Ansvarligansatt3id")
                        .HasColumnType("uuid")
                        .HasColumnName("ansvarligansatt3id");

                    b.Property<Guid?>("Ansvarligansatt4id")
                        .HasColumnType("uuid")
                        .HasColumnName("ansvarligansatt4id");

                    b.Property<Guid?>("Ansvarligansatt5id")
                        .HasColumnType("uuid")
                        .HasColumnName("ansvarligansatt5id");

                    b.Property<Guid>("Ansvarligansattid")
                        .HasColumnType("uuid")
            ...
            modelBuilder.Entity("SeaEco.EntityFramework.Entities.BProvetakingsplan", b =>
                {
                    ...
                    b.Property<Guid?>("Planlegger2id")
                        .HasColumnType("uuid")
                        .HasColumnName("planlegger2id");

                    b.Property<Guid>("Planleggerid")
                        .HasColumnType("uuid")
            ...
            modelBuilder.Entity("SeaEco.EntityFramework.Entities.BRapport", b =>
                {
                    ...
                    b.Property<Guid>("Generertavid")
                        .HasColumnType("uuid")
                        .HasColumnName("generertavid");

                    b.Property<Guid>("Godkjentavid")
                        .HasColumnType("uuid")
